    ...
    return (
        <div>
            ...
            <div className="searchfriend" style={{ display: "inline-block" }}>
                ...
                />
                <button className="search" onClick={() => {if(isNaN(Number(friend)) || friend.length >= 10) {alert("非法id");} else{router.push(`/user/searchfriend_by_id_result?id=${friend}`);} }}>按id查找</button>
